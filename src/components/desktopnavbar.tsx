    ...
    <div className="flex w-full bg-slate-800 shadow-md backdrop-blur-md max-md:hidden">
      ...
      <ul className="z-10 flex w-full flex-row justify-center">
        {links.map((link: NavLink, i: number) => (
          <div key={link.text} className="flex">
            {i !== 0 ? (
              <div
            ...
            <li className="m-2 border-b-2 border-green-300 border-opacity-0 p-2 text-zinc-300 hover:border-opacity-100 hover:text-zinc-400">
