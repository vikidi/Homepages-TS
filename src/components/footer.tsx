export default function Footer() {
  return (
    <footer className="flex flex-col justify-center bg-slate-900/80 shadow-md backdrop-blur-md">
      ...
      <div className="m-4 mt-2 flex justify-center text-zinc-300">
        &copy; Ville Saarinen, {new Date().getFullYear()}
      </div>
    </footer>
  );
}
